...
[[
『パワーチャージ』をおぼえたね！これは大事だよー。

パワーチャージ マークをタッチすると文字通り
 『パワー』 を溜めることができるんだ。
]])
      popup:setText(1, "溜めよう！『パワーチャージ』！", 
[[
『パワー』 を溜めると次のワザの効果がアップ！

『アタック』なら、ふつう3回攻撃しないと倒せない
モンスターも１回で倒せたりするよ！
]])
      popup:setText(2, "『パワーチャージ』を使いこなそう", [[
でもね、『パワー』 はワザを使うと、
すぐ使い切っちゃうから気を付けて！

モンスターの強さをよーく見極めて、そのままたたかうか、
『パワーチャージ』で強力な一撃にするか、
状況をじょうずに判断して使いわけていこう！
]])
    elseif level == 6 then
      local popup = layer:addPopupWindow(1)
      popup:setText(0, "『さいだいパワー』ですっごい一撃", [[
気づいたかもしれないけど、じつは『パワー』は4回まで
溜めることができるんだ。

溜めれば溜めるほど、次に使うワザの効果がアップして
いくよ！余裕をつくって溜めまくって、
体力の高いモンスターも一撃で粉砕だー！！
]])
    elseif level == 7 then
