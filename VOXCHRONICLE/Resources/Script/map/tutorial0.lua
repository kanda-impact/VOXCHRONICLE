...
３０レベルでゲームクリアだよ！！]])
      popup:setText(1, 
"攻撃は、近くの敵に", 
[[あとね。攻撃は基本的に一番近くの敵に当たるから、「近づく敵は全て切る！」って感じでどんどん倒していっちゃおう！]]
)
      popup:setText(2, 
"攻撃を繋げて威力アップ！", "ちなみに『攻撃』コマンドは連続すると、連撃になるよ！攻撃力も上がるし、音も変わって気持ち、イイ！"
)
    elseif level == 3 then
      local popup = layer:addPopupWindow(1)
      popup:setText(0, "敵の体力と色", 
[[
さっき敵を攻撃してた時、色が変わっていったことには気付いたかな？　
そう！敵の残り体力は、敵の色で分かるんだ！（だいたいだけど）　攻撃する前には敵の顔色をよ～くうかがっておこうね！
]])
    elseif level == 4 then
