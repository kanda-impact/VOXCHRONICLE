...
1ターン経つごとに行動が行われるんだ。
      ...
      popup:setText(3, "音楽にあわせて行動しよう！", [[
ターンは音楽に合わさっていて
下にあるタイムマーカーが一周するごとに
1ターン経過するのよ！

ターンが来ると選んだ行動（ワザ）をするわ。
ワザは先にえらんでおいて大丈夫よ！
まずは 剣 のマークをタッチして
『アタック』 のワザを試しましょ！


...作りかけだった頭出し。初回の人にあいさつするのをわすれていたのと
ターン制の表現を多少わかりやすくしようと必死になってるがうまくいってない。
ターンと呼んでいいのか？ターンの定義をしてからターンの説明をすべきか
ターンだよって言ってしまえば分るものなのか．．．
わからんまま時間がなくて作業できてない部分。


あとどこかで初代オクスの宣伝もしたいよね
チュートリ3かなぁ。
]]
